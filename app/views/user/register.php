<div class="container animate-fade-up" style="padding: 4rem 1rem;">
    <div class="form-container">
        <div style="text-align:center; margin-bottom: 2rem;">
            ...
            <h2 style="font-family:'Outfit',sans-serif; font-size:1.75rem;">Create an Account</h2>
            <p style="color:var(--text-secondary); margin-top:0.5rem;">Join <?= APP_NAME ?> today</p>
        </div>
        <?php if(isset($error)): ?>
        ...
        <p style="text-align:center; margin-top:2rem; color:var(--text-secondary);">
            Already have an account? <a href="<?= BASE_URL ?>/login" style="color:var(--primary); font-weight:600;">Log In</a>
        </p>
    </div>
</div>
